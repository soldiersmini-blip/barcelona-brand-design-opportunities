...
- `我的全部机会`：当前独立、相关、地点可行且有真实入口或可直接联系发布者确认的 242 条主表。
...
- `AUDIT-2026-08-12-ROUND31.md`：直连复核前 25 名；关闭已跳转 `error=true` 的 CATORCE Visual Designer，把 THRU 的正文/页脚冲突降为先确认，修复 Hungry Minds 岗位名；主表为 242 条、184 条 Barcelona 与 58 条远程，并新增 242 条当前主表和 1,246 条完整去重来源库下载。
...
- `current-opportunity-ledger.csv` / `current-opportunity-ledger.json`：当前 242 个机会的完整、严格降序导出。
