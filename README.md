...
- 74 个去重后的当前机会。
- 52 个 Barcelona / 周边机会。
- 22 个明确允许 Spain / Europe / worldwide remote 且人在西班牙可申请或可先核验的机会。
- 67 个原始详情页显示可投，7 个需要先确认。
- 3 个中文、华人圈或中国公司相关机会。
...
- `我的全部机会`：当前独立、相关、地点可行且有真实入口的 74 条主表。
...
- `AUDIT-2026-08-12-RECOVERY.md`：研究库追回后的 74 个机会现行总账、状态修正和统一排序说明。
