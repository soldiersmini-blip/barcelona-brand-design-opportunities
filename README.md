...
- `我的全部机会`：当前独立、相关、地点可行且有真实入口的 155 条主表。
...
- `AUDIT-2026-08-12-ROUND15.md`：纠正 MANGO 与 BRUTALIA 地点、恢复 Grupo RV、新增 Andilana，并隔离非传统 AI 项目池后的 155 条现行总账。
