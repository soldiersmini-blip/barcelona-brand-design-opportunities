...
- 52 个去重后的当前机会。
- 37 个 Barcelona / 周边机会。
- 15 个明确允许 Spain / Europe / worldwide remote 且人在西班牙可申请或可先核验的机会。
- 45 个原始详情页显示可投，7 个需要先确认。
- 3 个中文、华人圈或中国公司相关机会。
...
- `我的全部机会`：当前独立、相关、地点可行且有真实入口的 52 条主表。
...
- `AUDIT-2026-08-12-CONTINUED.md`：当前 52 个机会的最新人工复核总账和统一评分结果。
