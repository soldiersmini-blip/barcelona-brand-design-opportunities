...
- 151 个去重后的当前机会。
- 112 个 Barcelona / 周边机会。
- 39 个明确允许 Spain / Europe / worldwide remote 且人在西班牙可申请或可先核验的机会。
- 148 个原始详情页显示可投，3 个需要先确认。
...
- `我的全部机会`：当前独立、相关、地点可行且有真实入口的 151 条主表。
...
- `AUDIT-2026-08-12-ROUND14.md`：新增 Xapo、Kraken、Omnicom PowerPoint、Finary，恢复 DORTOKA，并关闭 Sanofi 与 Stanley 后的 151 条现行总账。
