...
- `我的全部机会`：当前独立、相关、地点可行且有真实入口或可直接联系发布者确认的 194 条主表。
...
- `current-opportunity-ledger.csv` / `current-opportunity-ledger.json`：当前 194 个机会的完整、严格降序导出。
